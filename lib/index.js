...
(function() {
  ...
  Teacss = (function() {
    ...
    Teacss.prototype.render = function(opts, dslFunc) {
      var e, head, space, unit;
      if (opts == null) {
        opts = {};
      }
      ...
      space = opts.space, unit = opts.unit, head = opts.head;
      this.unitStack = [unit];
      this.selectorStack = [];
      this.spaceStack = [];
      if (space) {
          ...
          if (/rgba?\s*\(/.test(value) || indexOf.call(directivesWithNoUnits, directiveDashed) >= 0) {
            ...
            for (idx = i = 0, len = parts.length; i < len; idx = ++i) {
              ...
              if (!isNaN(part) && +part !== 0) {
                parts[idx] = part + this.unitStack[this.unitStack.length - 1];
              }
            }
            return parts.join(' ');
          }
    ...
    Teacss.prototype.topSpace = function() {
      var space;
      if ((space = this.spaceStack[this.spaceStack.length - 1])) {
        return space + '-';
      } else {
        return '';
      }
    ...
    Teacss.prototype.topSelector = function(nestChar) {
      var selector;
      if ((selector = this.selectorStack[this.selectorStack.length - 1])) {
        return selector + nestChar;
      } else {
        return '';
      }
    };

    Teacss.prototype.addSpace = function(selector) {
      var __, dot, hash, lastIndex, matches, newSelector, regex;
      lastIndex = 0;
      newSelector = '';
      regex = new RegExp('(#)%|(\\.)%', 'g');
      while ((matches = regex.exec(selector))) {
        newSelector += selector.slice(lastIndex, matches.index);
        __ = matches[0], hash = matches[1], dot = matches[2];
        newSelector += (hash != null ? hash : '') + (dot != null ? dot : '') + this.topSpace();
        lastIndex = regex.lastIndex;
      }
    ...
    Teacss.prototype.nestFunc = function() {
      var arg, args, css, i, index, j, len, len1, name, nestChar, ref, ref1, ref2, sel, selector, selectors, space, topsel, unit, value;
      nestChar = arguments[0], args = 2 <= arguments.length ? slice.call(arguments, 1) : [];
      unit = space = selector = null;
      if ((ref = args != null ? (ref1 = args[0]) != null ? ref1[0] : void 0 : void 0) === '#' || ref === '.') {
        arg = args.shift();
        selectors = [];
        topsel = this.topSelector(nestChar);
        ref2 = this.addSpace(arg).split(',');
              ...
              for (name in arg) {
                ...
                switch (name) {
                  ...
                  case '_space':
                    ...
                    break;
                  default:
                    css += this.renderDirective(name, value);
                }
              }
              break;
            case 'function':
    ...
    Teacss.prototype._ = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.nestFunc.apply(this, [''].concat(slice.call(args)));
    };

    Teacss.prototype._s = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.nestFunc.apply(this, [' '].concat(slice.call(args)));
    };

    Teacss.prototype._v = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.nestFunc.apply(this, [' > '].concat(slice.call(args)));
    };

    Teacss.prototype._p = function() {
      var args;
      args = 1 <= arguments.length ? slice.call(arguments, 0) : [];
      return this.nestFunc.apply(this, [' + '].concat(slice.call(args)));
    };
    ...
    Teacss.prototype.tags = function() {
      return {
        ...
        _: this._.bind(this),
        _a: this._.bind(this),
        _s: this._s.bind(this),
        _v: this._v.bind(this),
        _p: this._p.bind(this)
      };
    };
